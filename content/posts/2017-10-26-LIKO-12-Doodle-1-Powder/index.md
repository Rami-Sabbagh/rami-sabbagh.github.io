...
summary: "A powder sandbox in LIKO-12"
...
![Test Run 1 GIF](assets/TestRun1.gif)
...
```
![Particle Case 1](assets/PState1.png)
```lua
		--Move the particle
...
```
![Particle Case 2](assets/PState2.png)
```lua
			--Move the particle
...
```
![Particle Case 3](assets/PState3.png)
```lua
			--Move the particle
			cimg:setPixel(x+1,y+1,pcol):setPixel(x,y,0)
...
![Test Run 2 GIF](assets/TestRun2.gif)
...
![Colorbox Sprite](assets/ColorBox.png)
