...
{{<alert>}}
**<u>Never ever attempt to do hacking without proper permission from the systems owners. Even for educational purposes.</u>** It's an unethical action and considered illegal in most countries including Syria. The post here has been left as a demonstration on how househeld routers can be insecure.
{{</alert>}}
...
![00-wireless-password.png](assets/00-wireless-password.png)
...
![00-router-login-page.png](assets/00-router-login-page.png)
...
![01-list-networks.png](assets/01-list-networks.png)
...
![02-kill-manager.png](assets/02-kill-manager.png)
...
![03-enable-monitor-mode.png](assets/03-enable-monitor-mode.png)
...
![04-device-found.png](assets/04-device-found.png)
...
![05-deauth.png](assets/05-deauth.png)
...
![06-handshake-captured.png](assets/06-handshake-captured.png)
...
![07-disable-monitor-mode.png](assets/07-disable-monitor-mode.png)

And start the network manager back from the start menu entry

![08-start-network-manager.png](assets/08-start-network-manager.png)
...
![09-wireshark.png](assets/09-wireshark.png)

### 2. Add in the wifi password

Go `Edit -> Perferences`

![10-preferences.png](assets/10-preferences.png)

Then `Protocols -> IEEE 802.11`, press `Edit...` near the `Decyption keys` text

![11-protocol.png](assets/11-protocol.png)
...
![13-follow-tcp-steam.png](assets/13-follow-tcp-steam.png)

### 4. Find the authorization cookie and decode it

![14-cookie-found.png](assets/14-cookie-found.png)
...
![15-bandwidth-control.png](assets/15-bandwidth-control.png)
