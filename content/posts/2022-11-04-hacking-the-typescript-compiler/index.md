...
summary: A post on auto generating code at each compile with extracted type information.
# toc: true
# authors: [rami-sabbagh]
# tags: [programming, typescript, compiler] # they affect open-graph (social media)
# categories: []
# series: []
...
![Spend 10 minutes doing the task manually: no. Spend 10 hours writing code to automate it: YES.](assets/automation-meme.jpg)
